...
final List<Product> mockProducts = [
  Product(
    ...
    description:
        'Premium cotton hoodie with embroidered AGU crest. Designed for everyday comfort and campus pride.',
  ...
  Product(
    ...
    description:
        'Soft-touch shirt featuring the new AGU typography lockup. Lightweight and breathable.',
  ...
  Product(
    ...
    description:
        'Insulated water bottle keeps drinks cold for 24 hours. Laser-etched crest with matte finish.',
  ...
  Product(
    ...
    description:
        'Throwback corduroy cap with raised AGU lettering. Adjustable back closure and interior moisture band.',
  ...
  Product(
    ...
    description:
        'Three-pack of recycled paper notebooks with subtle AGU branding. Includes dotted, lined, and blank pages.',
    colors: ['Neutral'],
    sizes: ['A5'],
    inventory: 120,
    badges: ['Sustainable'],
